...
2. Create .env file in the root directory and update the values for each key
   ...
   - SERVER_URL: It could be something like "http://localhost:4001"
   - PORT_NUMBER: Set a port number you want to use (e.g., 4001)
